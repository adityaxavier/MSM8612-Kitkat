...
static struct clk_lookup msm_clocks_8610[] = {
	...
	CLK_LOOKUP("cam_src_clk", mclk1_clk_src.c, "6-0022"),
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6-0072"),
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6-0074"),
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6-006c"),
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6-0036"),
	...
	CLK_LOOKUP("cam_clk", mclk1_clk.c, "6-0022"),
	CLK_LOOKUP("cam_clk", mclk0_clk.c, "6-0072"),
	CLK_LOOKUP("cam_clk", mclk0_clk.c, "6-0074"),
	CLK_LOOKUP("cam_clk", mclk0_clk.c, "6-006c"),
	CLK_LOOKUP("cam_clk", mclk0_clk.c, "6-0036"),
